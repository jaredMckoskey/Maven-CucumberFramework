...
public class Constants {
    ...
    public static final String TEST_OBJECT_URL = "";
    public static final String TEST_OBJECT_API_KEY_ANDROID = "";
    public static final String TEST_OBJECT_API_KEY_IOS = "";
    public static final String TEST_OBJECT_SESSION__CREATION_TIMEOUT = "";
    public static final String TEST_OBJECT_SUITE_NAME = "";
